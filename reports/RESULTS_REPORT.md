...
**最终 Z₂ = 19.0825**（warm-start SA 优化，从 18.94 提升至 19.08）。
...
**多起点稳定性**：6 起点 SA + warm-start 精修后 Z₂ = 19.08，约束全部 0 违反。
...
**Z₃**：动态 = 7.9167，静态 = 6.6376，**动态改善 19.27%**（动态≥静态，符合递进性）。
...
- 黄金时段覆盖率：实际 33.3%，优化 76.4%——**优化更优**（商业价值更高）。
