...
#abstract-cn[
  ...
  针对问题二，建立 $Z_2 = 0.25T+0.25B+0.15U+0.10H-0.08C-0.07D-0.06F-0.04R$ 的综合目标函数，决策变量为 72 场的场馆与开球时段。采用贪心初始（按轮次划分日期窗口保证 60 小时休息可行）+ 模拟退火 + 8 起点并行 + 定向修复 + warm-start SA 精修。最终 $Z_2 = 19.11$，9 类约束全部 0 违反。
