...
#abstract-cn[
  ...
  对于问题三（4000 条带时间窗与任务类型的多日排班，24 架飞机配额），采用两阶段策略：阶段 A 排非临时 3840 条得总飞机使用时间 $T_0$=53358 min，阶段 B 将 160 条临时任务以零额外时间插入现有架次。最终临时任务满足 159/160（98.1%），非临时服务 3705/3840（96.5%）。所有结果均经独立校验，续航、时刻链、运营窗与周转约束全部满足。
][
